...
const Persona1 = L.marker([-12.074502, -77.035985], { icon: iconoPersona }).addTo(map);
...
const lineaRuta1 = L.polyline(rutaEstacion1, {
    color: 'navy',
    weight: 6,
    opacity: 0.8,
}).addTo(map);
...
const BanderaVerde = L.marker([-12.067998, -77.034635], { icon: iconoBanderaVerde }).addTo(map);
...
const BanderaVerde2 = L.marker([-12.070737, -77.041319], { icon: iconoBanderaVerde2 }).addTo(map);
BanderaVerde.bindPopup("<strong>Mi Llegada</strong><br>Jr. Puno 3244");